...
{
    /// <inheritdoc />
    public partial class addingjobapplications : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LicenseCertificationNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PreviousWorkExperience = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                    NursingCompetencies = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    PreferredShift = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LearningMaterials_CourseModules_ModuleId",
                        column: x => x.ModuleId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QuizAttempts_CourseEnrollments_EnrollmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LearningMaterials_ModuleId",
