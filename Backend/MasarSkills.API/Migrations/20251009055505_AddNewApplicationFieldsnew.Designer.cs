...
namespace MasarSkills.API.Migrations
{
    ...
    [Migration("20251009055505_AddNewApplicationFieldsnew")]
    partial class AddNewApplicationFieldsnew
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MasarSkills.API.Models.JobApplication", b =>
                {
                    ...
                    b.Property<string>("LicenseCertificationNumber")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("NursingCompetencies")
                        .IsRequired()
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)");

                    b.Property<string>("PreferredShift")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.Property<string>("PreviousWorkExperience")
                        .IsRequired()
                        .HasMaxLength(2000)
